...
{ id: 2, name: "OG Kush", mainCategory: "weed", subCategory: "indica", thc: 25, cbd: 0.5, pricePerGram: 500, rating: 4.9, reviews: 24, effects: ["Relaxing", "Heavy", "Sleepy"], badge: "Strong", stock: "In Stock", image: weedImage, description: "Heavy-hitting indica with deep body relaxation and earthy pine flavor.", },

{ id: 3, name: "Gelato 41", mainCategory: "weed", subCategory: "hybrid", thc: 24, cbd: 0.7, pricePerGram: 550, rating: 4.7, reviews: 15, effects: ["Balanced", "Euphoric", "Happy"], badge: "Premium", stock: "Limited", image: weedImage, description: "Balanced hybrid with creamy citrus notes and smooth smoke.", },

{ id: 4, name: "Oil Spill", mainCategory: "weed", subCategory: "hybrid", thc: 18, cbd: 1, pricePerGram: 400, rating: 4.2, reviews: 15, effects: ["Euphoric", "Relaxed", "Uplifting"], badge: "Balanced Hybrid", stock: "In Stock", image: weedImage, description: "Sweet fruity nose with diesel undertones and a creeping balanced high that’s both euphoric and relaxing for all-day enjoyment.", },

{ id: 5, name: "Halle Berry", mainCategory: "weed", subCategory: "hybrid", thc: 20, cbd: 1, pricePerGram: 450, rating: 4.5, reviews: 25, effects: ["Relaxed", "Euphoric", "Happy"], badge: "Top Rated", stock: "In Stock", image: weedImage, description: "Balanced hybrid with sweet orange berry aroma and a calming, euphoric high perfect for unwinding and social vibes.", },

{ id: 6, name: "Blue Zushi", mainCategory: "weed", subCategory: "hybrid", thc: 24, cbd: 0, pricePerGram: 420, rating: 4.7, reviews: 40, effects: ["Euphoric", "Relaxed", "Tingly"], badge: "Customer Favorite", stock: "In Stock", image: weedImage, description: "Indica-leaning hybrid with sweet blueberry sweetness and a calming yet euphoric buzz perfect for stress relief.", },

{ id: 7, name: "Blockberry", mainCategory: "weed", subCategory: "hybrid", thc: 28, cbd: 1, pricePerGram: 480, rating: 4.6, reviews: 30, effects: ["Creative", "Euphoric", "Focused"], badge: "Popular Pick", stock: "In Stock", image: weedImage, description: "Balanced hybrid with berry, citrus and vanilla notes that spark creativity and deliver a joyful, uplifting head high.", },

{ id: 8, name: "Subo Cherry", mainCategory: "weed", subCategory: "hybrid", thc: 24, cbd: 1, pricePerGram: 480, rating: 4.6, reviews: 21, effects: ["Euphoric", "Relaxed", "Happy"], badge: "New Drop", stock: "In Stock", image: weedImage, description: "Sweet cherry aroma with creamy undertones and a smooth euphoric high that melts into relaxing body calm.", },
...
{ id: 11, name: "Cookie Creme", mainCategory: "weed", subCategory: "hybrid", thc: 22, cbd: 1, pricePerGram: 420, rating: 4.5, reviews: 29, effects: ["Relaxed", "Happy", "Sleepy"], badge: "Popular Pick", stock: "In Stock", image: weedImage, description: "Sweet vanilla cookie flavor with earthy hints and a relaxing euphoric high perfect for evening unwinding.", },

{ id: 12, name: "Honey Creme", mainCategory: "weed", subCategory: "indica", thc: 21, cbd: 1, pricePerGram: 430, rating: 4.3, reviews: 14, effects: ["Relaxed", "Sleepy", "Calm"], badge: "", stock: "In Stock", image: weedImage, description: "Rich honey sweetness with creamy undertones delivering a soothing body high ideal for stress relief.", },

{ id: 13, name: "Durban Poison", mainCategory: "weed", subCategory: "sativa", thc: 24, cbd: 0, pricePerGram: 460, rating: 4.7, reviews: 52, effects: ["Energetic", "Focused", "Uplifting"], badge: "Classic", stock: "In Stock", image: weedImage, description: "Sweet earthy pine aroma with a clear energetic high that boosts focus and daytime productivity.", },
...
{ id: 17, name: "Golden Apple", mainCategory: "weed", subCategory: "hybrid", thc: 23, cbd: 1, pricePerGram: 470, rating: 4.6, reviews: 23, effects: ["Happy", "Uplifting", "Focused"], badge: "", stock: "In Stock", image: weedImage, description: "Sweet apple and citrus aroma with a smooth uplifting high that balances focus and relaxation.", },

{ id: 18, name: "Super Boof Cherry", mainCategory: "weed", subCategory: "hybrid", thc: 28, cbd: 1, pricePerGram: 520, rating: 4.9, reviews: 38, effects: ["Euphoric", "Creative", "Relaxed"], badge: "Top Seller", stock: "In Stock", image: weedImage, description: "Sweet cherry citrus flavor with creamy gas notes delivering a strong euphoric high and smooth body buzz.", },

{ id: 19, name: "Purple Punch", mainCategory: "weed", subCategory: "indica", thc: 23, cbd: 1, pricePerGram: 450, rating: 4.7, reviews: 73, effects: ["Relaxed", "Sleepy", "Happy"], badge: "Top Rated", stock: "In Stock", image: weedImage, description: "Sweet grape and blueberry flavor with a deeply relaxing body high perfect for nighttime relief.", },

{ id: 20, name: "AK-47", mainCategory: "weed", subCategory: "hybrid", thc: 20, cbd: 1, pricePerGram: 430, rating: 4.6, reviews: 85, effects: ["Relaxed", "Creative", "Uplifting"], badge: "Classic", stock: "In Stock", image: weedImage, description: "Earthy floral aroma with subtle sweetness delivering a balanced uplifting high and calm body relaxation.", },
...
{ id: 22, name: "Nola Dang Pre-Roll", mainCategory: "pre-rolled", subCategory: "hybrid", price: 200, rating: 5, reviews: 17, badge: "Ready to Smoke", stock: "Available", image: preRolledImage, description: "Smooth and balanced Nola Dang hybrid pre-roll with earthy and slightly citrus notes. Expect a relaxing body buzz combined with an uplifting, happy head high — perfect for any time of day.", },

{ id: 23, name: "Nol Pre-Roll", mainCategory: "pre-rolled", subCategory: "hybrid", price: 200, rating: 5, reviews: 55, badge: "Ready to Smoke", stock: "Available", image: preRolledImage, description: "Smooth and balanced Nola Dang hybrid pre-roll with earthy and slightly citrus notes. Expect a relaxing body buzz combined with an uplifting, happy head high — perfect for any time of day.", },

{ id: 24, name: "OG Kush Pre-Roll", mainCategory: "pre-rolled", subCategory: "sativa", price: 200, rating: 5, reviews: 283, badge: "Ready to Smoke", stock: "Available", image: preRolledImage, description: "Classic OG Kush pre-roll with bold earthy pine and diesel flavors. Delivers an uplifting cerebral buzz with smooth relaxing undertones — a timeless favorite for stress relief and good vibes.", },
...
{ id: 26, name: "Money Maker Pre-Roll", mainCategory: "pre-rolled", subCategory: "hybrid", price: 200, rating: 5, reviews: 84, badge: "Ready to Smoke", stock: "Available", image: preRolledImage, description: "Powerful Money Maker pre-roll featuring rich earthy and herbal flavors. Known for its strong relaxing body effects and calm, euphoric head high — ideal for winding down.", },
